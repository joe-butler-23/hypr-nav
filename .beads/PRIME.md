...
- **Git/Dolt workflow**: Stage only intended paths, commit coherent units as work progresses, push completed tranches, and sync Beads. This maintenance is expected.
